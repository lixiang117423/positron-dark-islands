# Islands Dark for Positron

> **Forked from [bwya77/vscode-dark-islands](https://github.com/bwya77/vscode-dark-islands)**

A dark color theme for **Positron** (and VS Code) inspired by the easemate IDE. Features floating glass-like panels, rounded corners, smooth animations, and a deeply refined UI.

This fork adds Positron-specific CSS styling for Console, Plots, Data Explorer, Variables, Connections, and Help panes.

<a href="https://github.com/bwya77/vscode-dark-islands">
    <img src="https://img.shields.io/badge/Original%20Project-vscode--dark--islands-blue?style=for-the-badge&logo=github" />
</a>
...
```bash
curl -fsSL https://raw.githubusercontent.com/lixiang117423/positron-dark-islands/main/bootstrap.sh | bash
```

#### Windows

```powershell
irm https://raw.githubusercontent.com/lixiang117423/positron-dark-islands/main/bootstrap.ps1 | iex
```
